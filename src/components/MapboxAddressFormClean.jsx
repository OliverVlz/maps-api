    ...
    const loadMunicipios = async () => {
      ...
      try {
        ...
        if (data.municipios && Array.isArray(data.municipios)) {
          ...
          console.log('✅ Mapbox - Municipios cargados desde archivo local:', municipiosFromLocal.length)
        }
      } catch (localError) {
        console.warn('⚠️ Mapbox - Error cargando municipios:', localError.message)
        ...
        const fallbackMunicipios = [
          ...
          'Toa Baja', 'Mayagüez', 'Trujillo Alto', 'Ponce', 'Aguadilla', 'Humacao'
        ].sort()
